...
Description:
Ce projet est une petite application web de calculatrice faite en Python avec Flask. Elle permet de faire des calculs simples comme l’addition, la soustraction, la multiplication et la division à partir d’une page web.

Objectif: Faire des calculs à l'aide d'une calculatrice simple.

Prérequis:
Avant de commencer, il faut avoir Python version 3.8 ou plus récent, pip pour installer les bibliothèques Python et Git pour télécharger le projet.
